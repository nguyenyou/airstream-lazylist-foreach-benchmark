...
The benchmark reports median wall-clock time over seven measured runs after three warmups under both Bun and Node.js. It is a focused algorithm comparison, not a complete Airstream application benchmark; bundle-size differences are standalone linker output.
